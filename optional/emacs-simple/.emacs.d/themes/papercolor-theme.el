...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,heading1 :height 1.1))))
   `(org-level-2 ((,class (:bold nil :foreground ,heading2))))
   `(org-level-3 ((,class (:bold t :foreground ,heading3))))
   `(org-level-4 ((,class (:bold nil :foreground ,heading4))))
